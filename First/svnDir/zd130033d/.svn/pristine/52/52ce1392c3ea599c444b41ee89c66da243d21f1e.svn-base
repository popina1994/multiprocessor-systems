...
int main(int argc, char *argv[]) {
	...
	MPI_Bcast(&a, 1, MPI_DOUBLE, MASTER_RANK, MPI_COMM_WORLD);
	MPI_Bcast(&b, 1, MPI_DOUBLE, MASTER_RANK, MPI_COMM_WORLD);
	...
	if (MASTER_RANK == rank) {
		...
		// Quadratic rule  
		MPI_Bcast(&n, 1, MPI_INT, MASTER_RANK, mpiComm[0]);
		MPI_Bcast(&a, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[0]);
		MPI_Bcast(&b, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[0]);
		...
		MPI_Bcast(&n, 1, MPI_INT, MASTER_RANK, mpiComm[1]);
		MPI_Bcast(&a, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[1]);
		MPI_Bcast(&b, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[1]);
		...
		MPI_Bcast(&n, 1, MPI_INT, MASTER_RANK, mpiComm[2]);
		MPI_Bcast(&a, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[2]);
		MPI_Bcast(&b, 1, MPI_DOUBLE, MASTER_RANK, mpiComm[2]);
